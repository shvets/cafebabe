...
/**
 * An interpretator for "Deprecated" attribute.
 *
 * @version 1.0 02/22/2000
 * @author Alexander Shvets
 */
public final class DeprecatedAttribute extends AttributeInterpretator {

  public static final String TYPE = "DeprecatedAttribute";
   ...
   */
  public DeprecatedAttribute(AttributeEntry attribute) throws IOException {
    super(attribute);
  }
